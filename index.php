...
function initializeBot() {
    try {
        $webhook_url = getenv('RENDER_EXTERNAL_URL') . '/index.php';
...
// Initialization and status response
if (php_sapi_name() === 'cli') {
    // Command-line initialization
    initializeBot();
    echo "Webhook set to: " . getenv('RENDER_EXTERNAL_URL') . '/index.php';
} else {
    // Web request - show simple message
